...
public:
    Shooter(double position_x, double position_y, double vx_=100, double height=30, double width=18, double head_radius=8, Color color_=COLOR(50, 255, 0))
    {
        // Shooter constructor
        color = color_;
    ...
    void change_color2()
    {   // change color in appropriate life
      head.setColor(COLOR(220,20,60));
      head.setFill(true);
      body.setColor(COLOR(220,20,60));
      body.setFill(true);
    }
   ...
   void change_color3()
    ...
    void change_color()
    {
      head.setColor(COLOR(255,99,71));
      head.setFill(true);
      body.setColor(COLOR(255,99,71));
      body.setFill(true);
    }
